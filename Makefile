...
INC = -Iinclude
CFLAGS = -Wnon-virtual-dtor -Winit-self -Wundef -Wunreachable-code -Wmissing-include-dirs -Weffc++ -Wzero-as-null-pointer-constant -std=c++11 -fexceptions
RESINC = 
LIBDIR = 
...
INC_DEBUG = $(INC)
CFLAGS_DEBUG = $(CFLAGS) -Wredundant-decls -Wcast-align -Wall -g -DDEBUG
RESINC_DEBUG = $(RESINC)
